...
<body>
  <a href="/"><img src="{{ asset('images/DokterHama-logo-mini.png') }}" alt="Logo" class="logo"></a>
    <div class="login-box login-form">
      <h2 class="text-center mb-4 text-white h5">CLIENT LOGIN</h2>
      <form>
        ...
        <button type="submit" class="btn btn-primary w-75 p-2 mx-auto btn-block btn-small"><strong>LOGIN</strong></button>
      </form>
    </div>
  </body>
</html>